...
def test_workflow(adata_oligodendroma):
    ...
    cnv.tl.louvain(adata_oligodendroma)
    cnv.tl.cnv_score(adata_oligodendroma)

    cnv.pl.umap(adata_oligodendroma, color=["cnv_score", "cnv_cluster"], show=False)
    cnv.pl.tsne(adata_oligodendroma, color=["cnv_score", "cnv_cluster"], show=False)
